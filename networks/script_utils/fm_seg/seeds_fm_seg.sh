...
#SBATCH --output=/scratch/work/%u/diplomi/image-segmentation-playground/experiment_runs/stable_fm_seg/out/%A_%a.out
#SBATCH --gres=gpu:1
#SBATCH --mem=9000
#SBATCH --array=0-14
...
LOG_PREFIX="DiXe_randn_${rand_aug_N}_${N_ramp_up_consistency}_${consistency_augmentation_type}_${augmentation_type}_${seed}_${lambd}"
echo $LOG_PREFIX
